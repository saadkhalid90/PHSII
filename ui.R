                         ...
                         conditionalPanel("input.select_ind_type == 'IM'",
                                          radioButtons("age_group", label = h4("Select age group:"),
                                                       choices = list("1 - 11 months" = 1, 
                                                                      "12 - 23 months" = 2))),
                         conditionalPanel("input.select_ind_type == 'IM_cov'",
                                          radioButtons("age_group_1", label = h4("Select age group:"),
                                                       choices = list("12 - 23 months" = 1, 
                                                                      "0 - 11 months" = 2))),
